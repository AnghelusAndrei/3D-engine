...
vec3 Vec_RotateX(vec3 &v1, float ang){
    mat4x4 Rotated_MatrixX;
    vec3 vec;
    ...
    MultiplyMatrix(v1, vec, Rotated_MatrixX);

    return vec;
}

vec3 Vec_RotateY(vec3 &v1, float ang){
    mat4x4 Rotated_MatrixY;
    vec3 vec;
    ...
    MultiplyMatrix(v1, vec, Rotated_MatrixY);

    return vec;
}

vec3 Vec_RotateZ(vec3 &v1, float ang){
    mat4x4 Rotated_MatrixZ;
    vec3 vec;
    ...
    MultiplyMatrix(v1, vec, Rotated_MatrixZ);
